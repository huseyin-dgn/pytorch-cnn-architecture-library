...
class ConvBNAct(nn.Module):
    def __init__(self, cin, cout, k=3, s=1, p=1, negative_slope=0.1):
        super().__init__()
...
class TinyCNN_LeakyReLU(nn.Module):
    def __init__(self, num_classes=10, negative_slope=0.1):
        super().__init__()
        ...
        self.stage1 = nn.Sequential(
            ...
            ConvBNAct(64, 64, negative_slope=negative_slope),
        )

        self.stage2 = nn.Sequential(
            ConvBNAct(64, 128, s=2, negative_slope=negative_slope),
            ConvBNAct(128, 128, negative_slope=negative_slope),
        )
